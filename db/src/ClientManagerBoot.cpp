...
bool CClientManager::InitializeMobTable()
{
	...
	snprintf(query, sizeof(query),
		"SELECT "
		"vnum,name,%s,rank,type,battle_type,level,size,ai_flag,mount_capacity,"
		...
		"drop_item,resurrection_vnum,enchant_curse,enchant_slow,enchant_poison,"
		"enchant_stun,enchant_critical,enchant_penetrate,resist_sword,resist_twohand,"
		"resist_dagger,resist_bell,resist_fan,resist_bow,resist_fire,resist_elect,"
		"resist_magic,resist_wind,resist_poison,dam_multiply,summon,drain_sp,"
		"mob_color,polymorph_item,skill_level0,skill_vnum0,skill_level1,skill_vnum1,"
		"sp_berserk,sp_stoneskin,sp_godspeed,sp_deathblow,sp_revive,skill_level2,"
		"skill_vnum2,skill_level3,skill_vnum3,skill_level4,skill_vnum4 "
		"FROM mob_proto%s",
...
bool CClientManager::InitializeItemTable()
{
	...
	snprintf(query, sizeof(query),
		"SELECT vnum,name,%s,type,subtype,weight,size,antiflag,flag,wearflag,"
		"immuneflag+0,gold,shop_buy_price,refined_vnum,refine_set,magic_pct,"
		"limittype0,limitvalue0,limittype1,limitvalue1,applytype0,applyvalue0,"
		"applytype1,applyvalue1,applytype2,applyvalue2,value0,value1,value2,"
		"value3,value4,value5,socket_pct,addon_type "
	...
	while ((data = mysql_fetch_row(pRes->pSQLResult)))
	{
		...
		sys_log(0,
			"ITEM: #%-5lu %-24s %-24s VAL: %d %ld %d %d %d %d WEAR %d ANTI %d IMMUNE %d REFINE %lu REFINE_SET %u MAGIC_PCT %u",
			item_table->dwVnum,
			item_table->szName,
